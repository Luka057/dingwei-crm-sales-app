...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("contact_title", sa.String(64), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("target_person", sa.String(64), nullable=True),
        sa.Column("target_title", sa.String(64), nullable=True),
        sa.Column("content", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("sample_no", sa.String(64), nullable=False),
        sa.Column(
            "status",
            sa.String(32),
            nullable=False,
        ...
        sa.Column("width", sa.String(32), nullable=True),
        sa.Column("tension", sa.String(32), nullable=True),
        sa.Column("ribbon_type", sa.String(32), nullable=True),
