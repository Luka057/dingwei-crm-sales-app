...
> ## 📦 本仓库已于 2026-06-11 归档,只读封箱
>
> 按 2026-06-11 架构决策(路线 A),鼎伟 CRM 升级为单仓库开发,权威仓库迁至
> **[Luka057/dingwei-crm](https://github.com/Luka057/dingwei-crm)**(本地 `~/erp/crm`)。
> 本仓库保留为历史存档:FastAPI 真后端(`backend-python/`,将迁入新仓)、业务员端原型
> HTML(视觉契约,Taro 化时像素级遵从)、SigLIP2 vision-service(已被同事的 DINOv3
> 独立服务取代,作废不迁)。**此后不在本仓库开发任何功能。**
> 决策全文见新仓库 `docs/agent/handoffs/2026-06-11-2.md`。
